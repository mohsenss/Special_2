...
@onready var knife_cd_bar: ProgressBar = $HUD/Margin/AbilityRow/KnifeCooldown
...
func update_cooldowns(dash_ratio: float, knife_ratio: float, stealth_ratio: float, stealth_active: bool) -> void:
